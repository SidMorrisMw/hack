...
// ── All UI strings ──
$s = [
    'page_title'        => ['en' => 'Public Dashboard — LiwuLathu',                             'ny' => 'Tsamba Lalikulu — CitizenConnect'],
    ...
    'cons_label'        => ['en' => 'Select Constituency',                                           'ny' => 'Sankhani Dera'],
    'cons_choose'       => ['en' => '— Choose a constituency —',                                     'ny' => '— Sankhani dera —'],
    ...
    <nav class="bg-yazaBlue text-white py-4 px-5 sticky top-0 z-50 shadow-md">
        <div class="max-w-3xl mx-auto flex justify-between items-center">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <span class="font-extrabold text-lg tracking-tight">Liwu<span class="text-yazaGold">Lathu</span></span>
