...
$s = [
    ...
    's1_heading'        => ['en' => 'Who are you?',                                              'ny' => 'Ndani inu?'],
    's1_sub'            => ['en' => 'We use your phone number to avoid duplicate reports.',      'ny' => 'Tigwiritsa ntchito nambala yanu ya foni kuzepetsa malipoti owonjezereka.'],
    'phone_label'       => ['en' => 'Phone Number',                                              'ny' => 'Nambala ya Foni'],
    ...
    'cons_label'        => ['en' => 'Constituency',                                              'ny' => 'Bwaalo'],
    'cons_placeholder'  => ['en' => 'Search your constituency…',                                 'ny' => 'Fufuzani bwaalo lanu…'],
    'cons_err'          => ['en' => 'Please select a constituency from the list.',               'ny' => 'Sankhani bwaalo kuchokera pamndandanda.'],
    ...
    's2_heading'        => ['en' => 'How can we help?',                                          'ny' => 'Tingakuthandizeni bwanji?'],
    'report_title'      => ['en' => 'Report a New Issue',                                        'ny' => 'Longa Vuto Latsopano'],
    'report_sub'        => ['en' => 'Log a problem in your constituency.',                       'ny' => 'Lemba vuto mu bwaalo lanu.'],
    ...
    'submit_btn'        => ['en' => 'SUBMIT TO CONSTITUENCY',                                    'ny' => 'TUMIZANI KU BWAALO'],
...
<body class="font-sans antialiased">
    ...
    <nav class="bg-yazaBlue text-white py-4 px-5 sticky top-0 z-50 shadow-md">
        <div class="max-w-xl mx-auto flex justify-between items-center">
            <div class="flex items-center gap-3">
                ...
                <span class="font-extrabold text-xl tracking-tight">Citizen<span class="text-yazaGold">Connect</span></span>
            </div>
    ...
    <main class="max-w-xl mx-auto p-5 pb-28 space-y-0">
        ...
        <div id="step-1" class="step-layer active space-y-7 pt-4">
            <div>
                <p class="text-xs font-black uppercase tracking-widest text-gray-400 mb-1"><?= $t['s1_label'] ?></p>
        ...
        <div id="step-2" class="step-layer space-y-5 pt-4">
            <div>
                <p class="text-xs font-black uppercase tracking-widest text-gray-400 mb-1"><?= $t['s2_label'] ?></p>
            ...
            <button onclick="goToStep(1)" class="w-full text-center py-3 text-gray-400 font-bold uppercase text-xs tracking-widest">
        ...
        <div id="step-3" class="step-layer space-y-5 pt-4">
            ...
            <button onclick="goToStep(2)" class="w-full text-center py-3 text-gray-400 font-bold uppercase text-xs tracking-widest">
                <i class="fas fa-arrow-left mr-1"></i> <?= $t['go_back'] ?>
            </button>
        </div>
        ...
        <div id="step-report-final" class="step-layer space-y-5 pt-4">
            ...
            <div class="flex items-center gap-2">
                ...
                <span class="text-xs text-gray-400 font-semibold" id="constBadge"></span>
            </div>
            ...
            <button onclick="goToStep(3)" class="w-full text-center py-3 text-gray-400 font-bold uppercase text-xs tracking-widest">
